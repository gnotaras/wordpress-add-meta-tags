        ...
        if ( !empty($keyw_fld_content) ) {
            ...
            */
            ...
            if ($auto) {
                ...
                Only for POSTS!! (PAGES DO NOT SUPPORT CATEGORIES AND TAGS)
                */
...
function amt_add_meta_tags() {
	...
	*/
    ...
    // NOINDEX,FOLLOW on archives
    // First we perform this check, as there is no need to process metadata, if
    // if this setting is enabled and we deal with an archive webpage.
	...
	if ( is_front_page() ) {
		...
		*/
		...
		if ( !empty($site_description) ) {
			// If $site_description is not empty, then use it in the description meta-tag
