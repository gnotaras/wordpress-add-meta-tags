...
<strong>Is this an SEO plugin?</strong>
...
Moreover, although we have nothing against the strict compliance with the so called <em>SEO rules</em>, such practice has never been part of our mindset. We treat such rulesets as something temporary, a side effect. They could change at any time. Hence the lack of any such guidance by the plugin. Our general suggestion to users has always been to focus on research and on writing natural, high quality and original content and thus provide their readers with something truly useful. Keeping the general <em>webmaster guidelines</em> and the <em>SEO practices</em> in mind at any given moment is always a <em>Good Thing&trade;</em>, but, quite frankly, the real problem is never those extra 50 characters of the description.

<br /><br />

It might be a lot better if you invested your time in writing more useful content and researching more efficient ways to reach your specific audience. The metadata generated by this plugin technically facilitates indexing and sharing of your content and thus one could say that it makes the engagement with your target audience a little easier. If people are interested in your content, products or services, chances are that the search engines will notice it.

<br /><br />

So, is this an SEO plugin or not? We are going to leave the judgement about this to you as it really depends on your standpoint. For sure, your success does not depend on this plugin. It can help a little. But, high rankings in search results and overall success is really up to you. You make the decisions and do the hard work.
