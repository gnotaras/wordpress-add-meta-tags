...
Tags: amt, meta, metadata, seo, optimize, ranking, description, keywords, metatag, schema, opengraph, dublin core, schema.org, microdata, google, twitter cards, google plus, yahoo, bing, search engine optimization, rich snippets, semantic, meta tags
...
Opengraph meta tags can be automatically added to the front page, posts, pages and attachments.

**Schema.org Microdata**

Schema.org Microdata can be automatically added to the front page, posts, pages and image attachments.

**Twitter Cards**

Twitter Cards can be automatically added to content pages and image attachments.
